                    ...
                    <div class="row contact-info">
                        <div class="col-md-4">
                            ...
                            <div class="contact-email">
                                <a href="{{url('upload_files/home/SeriousGames/SeriousGamesInfo.jpg')}}" data-lightbox="portfolio" data-title="بازی های جدی" class="link-preview" title="Preview"><img src="{{ asset('img/Untitled-2.png') }}"  width="60" height="60"></a>
                                <p><a href=""></a></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="contact-address">
                                <a href="{{url('upload_files/home/SeriousGames/SeriousGame.pdf')}}"><img src="{{ asset('img/pdf.png') }}"  width="60" height="60"></a>
                            </div>
                        </div>
                    </div>
                </div>
